...
class UserTextModel extends DomainModel
{
    ...
    /**
     * Сохранить статистику в модели, а так же пометить модель как грязную, на обновление в БД
     * 
     * В markDirty передаётся массив с именем поля в таблице БД 
     * и именем метода для получения значения для этого поля из данной модели
     */
    ...
    /**
     * Сохранить лучшее значение статики в модели, а так же пометить модель как грязную, на обновление в БД
     * 
     * В markDirty передаётся массив с именем поля в таблице БД 
     * и именем метода для получения значения для этого поля из данной модели
     */
