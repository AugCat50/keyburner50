 ...
 * 
 * По сути, дочерние IdentityObject отличаются только захардкожеными array $enforce и string $tableName в __construct.
 * При желании, эти данные можно вынести в config.ini и оставить только один класс IdentityObject
 */
