 ...
 * 
 * ВНИМАНИЕ! Есть возможность обновлять только конкретные поля, а не все, используя метод модели getDirtyFields(),
 * см пример UserTextUpdateFactory.php
 */
